...
class AugmentPipe(torch.nn.Module):
    def __init__(self,
        ...
        self.brightness       = 0       # Probability multiplier for brightness.
        self.contrast         = 0         # Probability multiplier for contrast.
        self.lumaflip         = 0         # Probability multiplier for luma flip.
        self.hue              = 0              # Probability multiplier for hue rotation.
        self.saturation       = 0       # Probability multiplier for saturation.
        self.brightness_std   = 0   # Standard deviation of brightness.
        self.contrast_std     = 0     # Log2 standard deviation of contrast.
        self.hue_max          = 0          # Range of hue rotation, 1 = full circle.
        self.saturation_std   = 0   # Log2 standard deviation of saturation.
